...
/// 
/// </summary>
public sealed class BffWebApplication : IApplicationBuilder, IEndpointRouteBuilder
{
    ...
    internal BffWebApplication(IApplicationBuilder appBuilder, IEndpointRouteBuilder endpointRouteBuilder)
    {
    ...
    public BffWebApplication UseEndpoints(Action<IEndpointRouteBuilder> configure)
    {
