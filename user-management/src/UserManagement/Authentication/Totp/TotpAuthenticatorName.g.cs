...
[System.ComponentModel.TypeConverter(typeof(ValueOfTypeConverter<TotpAuthenticatorName, string>))]
partial record TotpAuthenticatorName : IStringValue<TotpAuthenticatorName>
{
    ...
    public static TotpAuthenticatorName Create(string s)
    {
        ...
        {
            throw new FormatException($"The value '{s}' is not a valid TotpAuthenticatorName. {string.Join(" ", errors)}");
        }
        return result;
    }
    ...
    public static bool TryCreate(string? s, [NotNullWhen(true)] out TotpAuthenticatorName? result, [NotNullWhen(false)] out IReadOnlyList<string>? errors)
    {
        ...
        result = new TotpAuthenticatorName(s);
        return true;
    }
