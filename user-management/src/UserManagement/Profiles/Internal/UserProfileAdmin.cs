...
internal sealed class UserProfileAdmin(UserProfileRepository repo, ISchemaStore schemaStore, ILogger<UserProfileAdmin> logger, UserManagementLicenseValidator licenseValidator) : IUserProfileAdmin
{
