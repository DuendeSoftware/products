...
public sealed class PasswordHistoryTests
{
    ...
    public async Task Cannot_reuse_current_password()
    {
        ...
        var password1 = await selfService.CreatePasswordAsync(userId, raw1, _ct);
        ...
        var reusedResult = await selfService.TryCreatePasswordAsync(userId, raw1, _ct);
    ...
    public async Task Cannot_reuse_password_in_history()
    {
        ...
        var password2 = await selfService.CreatePasswordAsync(userId, raw2, _ct);
    ...
    public async Task Password_pushed_out_of_history_window_can_be_reused()
    {
        ...
        for (var i = 0; i < 4; i++)
        {
            ...
            var passwordN = await selfService.CreatePasswordAsync(userId, rawN, _ct);
    ...
    public async Task Fresh_password_not_in_history_is_allowed()
    {
        ...
        var newResult = await selfService.TryCreatePasswordAsync(userId, rawNew, _ct);
