...
{
    extension(Entities.IdentityResource entity)
    {
        /// <summary>
        /// Maps an entity to a model.
        /// </summary>
        /// <returns></returns>
        public Models.IdentityResource ToModel() => entity == null ? null :
    ...
    extension(Models.IdentityResource model)
    {
        /// <summary>
        /// Maps a model to an entity.
        /// </summary>
        /// <returns></returns>
        public Entities.IdentityResource ToEntity() => model == null ? null :
