...
{
    extension(Entities.ApiResource entity)
    {
        /// <summary>
        /// Maps an entity to a model.
        /// </summary>
        /// <returns></returns>
        public Models.ApiResource ToModel() => entity == null ? null :
    ...
    extension(Models.ApiResource model)
    {
        /// <summary>
        /// Maps a model to an entity.
        /// </summary>
        /// <returns></returns>
        public Entities.ApiResource ToEntity() => model == null ? null :
