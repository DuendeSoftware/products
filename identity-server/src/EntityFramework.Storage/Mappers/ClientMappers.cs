...
{
    extension(Entities.Client entity)
    {
        /// <summary>
        /// Maps an entity to a model.
        /// </summary>
        /// <returns></returns>
        public Models.Client ToModel() => new Models.Client
        {
    ...
    extension(Models.Client model)
    {
        /// <summary>
        /// Maps a model to an entity.
        /// </summary>
        /// <returns></returns>
        public Entities.Client ToEntity() => new Entities.Client
        {
