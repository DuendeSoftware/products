...
public static class IdentityServerEntityFrameworkBuilderExtensions
{
    extension(IServiceCollection services)
    {
        ...
        /// <returns></returns>
        public IServiceCollection AddConfigurationDbContext(
        ...
        /// <param name="storeOptionsAction">The store options action.</param>
        /// <returns></returns>
        public IServiceCollection AddConfigurationDbContext<TContext>(
        ...
        /// <param name="storeOptionsAction">The store options action.</param>
        /// <returns></returns>
        public IServiceCollection AddOperationalDbContext(
        ...
        /// <param name="storeOptionsAction">The store options action.</param>
        /// <returns></returns>
        public IServiceCollection AddOperationalDbContext<TContext>(
        ...
        /// <returns></returns>
        public IServiceCollection AddOperationalStoreNotification<T>()
