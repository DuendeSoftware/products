...
public static class ModelBuilderExtensions
{
        ...
        where TEntity : class
    {
        private EntityTypeBuilder<TEntity> ToTable(TableConfiguration configuration) =>
            string.IsNullOrWhiteSpace(configuration.Schema) ? entityTypeBuilder.ToTable(configuration.Name) : entityTypeBuilder.ToTable(configuration.Name, configuration.Schema);
    }
    ...
    extension(ModelBuilder modelBuilder)
    {
        ...
        /// </summary>
        /// <param name="storeOptions">The store options.</param>
        public void ConfigureIdentityProviderContext(ConfigurationStoreOptions storeOptions)
        {
            if (!string.IsNullOrWhiteSpace(storeOptions.DefaultSchema))
            {
                modelBuilder.HasDefaultSchema(storeOptions.DefaultSchema);
        ...
        /// </summary>
        /// <param name="storeOptions">The store options.</param>
        public void ConfigureSamlServiceProviderContext(ConfigurationStoreOptions storeOptions)
        {
            if (!string.IsNullOrWhiteSpace(storeOptions.DefaultSchema))
            {
                modelBuilder.HasDefaultSchema(storeOptions.DefaultSchema);
