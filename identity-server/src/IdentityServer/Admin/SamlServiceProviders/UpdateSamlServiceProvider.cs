...
/// <summary>
/// Represents a SAML Service Provider configuration used to update an existing Service Provider.
/// Certificates submitted with an unset (<see cref="Guid.Empty"/>) <see cref="SamlCertificateInput.Id"/>
/// are assigned a fresh identifier; private key material, if present, is stripped.
/// </summary>
public sealed class UpdateSamlServiceProvider
{
    /// <summary>
    ...
    /// </summary>
    public List<SamlCertificateInput> Certificates { get; set; } = [];
