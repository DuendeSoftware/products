...
public interface ILogoutNotificationService
{
    ...
    Task<IReadOnlyCollection<string>> GetFrontChannelLogoutNotificationsUrlsAsync(LogoutNotificationContext context, Ct ct);
    ...
    /// <param name="context">The context for the logout notification.</param>
    /// <param name="ct">The cancellation token.</param>
    Task<IReadOnlyCollection<BackChannelLogoutRequest>> GetBackChannelLogoutNotificationsAsync(LogoutNotificationContext context, Ct ct);
}
