...
public static class IdentityServerBuilderExtensionsAdditional
{
    extension(IIdentityServerBuilder builder)
    {
        ...
        public IIdentityServerBuilder AddExtensionGrantValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddRedirectUriValidator<T>()
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddAppAuthRedirectUriValidator() => builder.AddRedirectUriValidator<StrictRedirectUriValidatorAppAuth>();
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddResourceOwnerValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddProfileService<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddResourceValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddScopeParser<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddClientStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddResourceStore<T>()
        ...
        public IIdentityServerBuilder AddDeviceFlowStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddPersistedGrantStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSigningKeyStore<T>()
        ...
        /// <typeparam name="T">The type of the concrete store that is registered in DI.</typeparam>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddPushedAuthorizationRequestStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSamlSigninStateStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSamlLogoutSessionStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCorsPolicyService<T>()
        ...
        /// <typeparam name="T">The type of the concrete CORS policy service that is registered in DI.</typeparam>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCorsPolicyCache<T>()
            where T : class, ICorsPolicyService
        {
            builder.EnsureConfigurationStoreHybridCache();
            builder.Services.TryAddScoped<CachePolicy<CorsCacheEntry>>(sp =>
                new CachePolicy<CorsCacheEntry>(
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSecretParser<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSecretValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddClientStoreCache<T>()
            where T : IClientStore
        {
            builder.EnsureConfigurationStoreHybridCache();
            builder.Services.TryAddScoped<CachePolicy<Client>>(sp =>
                new CachePolicy<Client>(
                    sp.GetService<ISpaceContextAccessor>()));
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddResourceStoreCache<T>()
            where T : IResourceStore
        {
            builder.EnsureConfigurationStoreHybridCache();
            builder.Services.TryAddScoped<CachePolicy<Resources>>(sp =>
                new CachePolicy<Resources>(
                    sp.GetService<ISpaceContextAccessor>()));
            builder.Services.TryAddTransient(typeof(T));
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddIdentityProviderStoreCache<T>()
            where T : IIdentityProviderStore
        {
            builder.EnsureConfigurationStoreHybridCache();
            builder.Services.TryAddScoped<CachePolicy<IdentityProvider>>(sp =>
                new CachePolicy<IdentityProvider>(
                    sp.GetService<ISpaceContextAccessor>()));
            builder.Services.TryAddScoped<CachePolicy<IdentityProviderName>>(sp =>
                new CachePolicy<IdentityProviderName>(
                    sp.GetService<ISpaceContextAccessor>()));
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddAuthorizeInteractionResponseGenerator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCustomAuthorizeRequestValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCustomTokenRequestValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCustomBackchannelAuthenticationRequestValidator<T>()
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddJwtBearerClientAuthentication()
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddClientConfigurationValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddIdentityProviderConfigurationValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSamlServiceProviderConfigurationValidator<T>()
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddMutualTlsSecretValidators()
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddBackChannelLogoutService<T>()
        ...
        public IHttpClientBuilder AddBackChannelLogoutHttpClient(Action<HttpClient>? configureClient = null)
        {
        ...
        /// If not provided, a default timeout of <see cref="IdentityServerConstants.HttpClients.DefaultTimeoutSeconds"/> is applied.</param>
        /// <returns>An <see cref="IHttpClientBuilder"/> for further HTTP client configuration (e.g. adding handlers).</returns>
        public IHttpClientBuilder AddJwtRequestUriHttpClient(Action<HttpClient>? configureClient = null)
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddUserSession<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddIdentityProviderStore<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddBackchannelAuthenticationUserValidator<T>()
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddBackchannelAuthenticationUserNotificationService<T>()
