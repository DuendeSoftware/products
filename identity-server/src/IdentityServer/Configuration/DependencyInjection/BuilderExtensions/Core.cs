...
public static class IdentityServerBuilderExtensionsCore
{
    extension(IIdentityServerBuilder builder)
    {
        ...
        public IIdentityServerBuilder AddRequiredPlatformServices()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCookieAuthentication() => builder
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDefaultCookieHandlers()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddCookieAuthenticationExtensions()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDefaultEndpoints()
        {
        ...
        public IIdentityServerBuilder AddEndpoint<TEndpoint>(string name, PathString path, Func<HttpContext, bool>? isMatch = null)
        ...
        /// </summary>
        public IIdentityServerBuilder AddHttpWriter<TResult, TWriter>()
        ...
        /// </summary>
        public IIdentityServerBuilder AddCoreServices()
        {
            ...
            builder.Services.AddTransient<ISamlServiceProviderConfigurationValidator, DefaultSamlServiceProviderConfigurationValidator>();
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddPluggableServices()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddKeyManagement()
        {
            ...
            builder.Services.TryAddSingleton<InMemoryKeyStoreCacheState>();
            builder.Services.TryAddScoped<ISigningKeyStoreCache>(sp =>
                new InMemoryKeyStoreCache(
                    sp.GetRequiredService<TimeProvider>(),
                    sp.GetRequiredService<InMemoryKeyStoreCacheState>(),
            ...
            builder.Services.TryAddSingleton<ISigningKeyStore, FileSystemKeyStore>();
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDynamicProvidersCore()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddValidators()
        {
            // core
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddResponseGenerators()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDefaultSecretParsers()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDefaultSecretValidators()
        {
        ...
        /// </summary>
        public IIdentityServerBuilder AddLicenseSummary()
        {
    ...
    {
        internal void AddTransientDecorator<TService, TImplementation>()
        ...
        internal void AddDecorator<TService>()
        {
