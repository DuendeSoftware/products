...
public static class IdentityServerBuilderExtensionsCrypto
{
    extension(IIdentityServerBuilder builder)
    {
        ...
        public IIdentityServerBuilder AddSigningCredential(SigningCredentials credential)
        {
        ...
        public IIdentityServerBuilder AddSigningCredential(X509Certificate2 certificate, string signingAlgorithm = SecurityAlgorithms.RsaSha256)
        {
        ...
        public IIdentityServerBuilder AddSigningCredential(
            string name,
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSigningCredential(SecurityKey key, string signingAlgorithm)
        {
            var credential = new SigningCredentials(key, signingAlgorithm);
            return builder.AddSigningCredential(credential);
        }
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSigningCredential(RsaSecurityKey key, IdentityServerConstants.RsaSigningAlgorithm signingAlgorithm)
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddSigningCredential(ECDsaSecurityKey key, IdentityServerConstants.ECDsaSigningAlgorithm signingAlgorithm)
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddDeveloperSigningCredential(
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddValidationKey(params SecurityKeyInfo[] keys)
        {
        ...
        /// <returns>The <see cref="IIdentityServerBuilder"/> for chaining.</returns>
        public IIdentityServerBuilder AddValidationKey(
            RsaSecurityKey key,
            IdentityServerConstants.RsaSigningAlgorithm signingAlgorithm = IdentityServerConstants.RsaSigningAlgorithm.RS256)
        {
            var keyInfo = new SecurityKeyInfo
