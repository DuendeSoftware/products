...
public static class SessionManagementServiceCollectionExtensions
{
    extension(IIdentityServerBuilder builder)
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IIdentityServerBuilder AddServerSideSessions<T>()
        ...
        /// </remarks>
        /// <returns></returns>
        public IIdentityServerBuilder AddServerSideSessions()
        {
        ...
        /// <returns></returns>
        public IIdentityServerBuilder AddServerSideSessionStore<T>()
            where T : class, IServerSideSessionStore
        {
