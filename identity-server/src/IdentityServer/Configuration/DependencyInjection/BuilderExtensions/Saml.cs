...
public static class IdentityServerBuilderExtensionsSaml
{
    extension(IIdentityServerBuilder builder)
    {
        ...
        /// </remarks>
        /// <returns></returns>
        public IIdentityServerBuilder AddSaml() =>
            builder.AddSaml(_ => { });
        ...
        /// <returns></returns>
        public IIdentityServerBuilder AddSaml(Action<SamlOptions> configureSaml)
        {
        ...
        /// <returns></returns>
        private IIdentityServerBuilder AddSamlServices(SamlEndpointOptions endpoints)
        {
        ...
        /// <returns></returns>
        public IIdentityServerBuilder AddSamlServiceProviderStore<T>()
        ...
        /// <returns></returns>
        public IIdentityServerBuilder AddSamlServiceProviderStoreCache<T>()
            where T : class, ISamlServiceProviderStore
        {
            builder.EnsureConfigurationStoreHybridCache();
            builder.Services.TryAddScoped<CachePolicy<SamlServiceProvider>>(sp =>
                new CachePolicy<SamlServiceProvider>(
