...
public static class AuthenticationPropertiesExtensions
{
    ...
    extension(AuthenticationProperties properties)
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string GetSessionId() => properties?.Items.TryGetValue(SessionIdKey, out var value) == true ? value : null;
        ...
        /// <returns></returns>
        public void SetSessionId(string sid) => properties.Items[SessionIdKey] = sid;
        ...
        /// </summary>
        public void RemoveClientList() => properties?.Items.Remove(ClientListKey);

        /// <summary>
        /// Sets the list of client ids.
        /// </summary>
        /// <param name="clientIds"></param>
        public void SetClientList(IEnumerable<string> clientIds)
        {
        ...
        /// </remarks>
        public IEnumerable<SamlSpSessionData> GetSamlSessionList()
        {
        ...
        public void SetSamlSessionList(IEnumerable<SamlSpSessionData> sessions)
        {
        ...
        public void AddSamlSession(SamlSpSessionData session)
        {
        ...
        public void RemoveSamlSession(string entityId)
        {
