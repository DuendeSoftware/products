...
public static class ServerUrlExtensions
{
    extension(IServerUrls urls)
    {
        ...
        /// </summary>
        public string GetAbsoluteUrl(string urlOrPath)
        {
        ...
        /// </summary>
        public string GetIdentityServerRelativeUrl(string path)
        {
            if (!path.IsLocalUrl())
            {
                return null;
