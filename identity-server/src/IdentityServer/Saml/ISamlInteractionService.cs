...
public interface ISamlInteractionService
{
    ...
    /// </summary>
    Task<SamlAuthenticationRequest?> GetAuthenticationRequestContextAsync(CancellationToken ct);
    ...
    /// <returns></returns>
    Task StoreRequestedAuthnContextResultAsync(bool requestedAuthnContextRequirementsWereMet, CancellationToken ct);
}
