    ...
    : IEndpointRouter
{
    ...
    private static readonly Type sanitizedLoggerType = typeof(IEndpointRouter).Assembly
        .GetType("Duende.IdentityServer.Logging.SanitizedLogger`1")!.MakeGenericType(
        typeof(OTelEndpointRouter))!;

    private static readonly MethodInfo sanitizedLoggerDebug =
        sanitizedLoggerType.GetMethod("LogDebug", BindingFlags.Public | BindingFlags.Instance)!;

    private static readonly MethodInfo sanitizedLoggerWarning =
        sanitizedLoggerType.GetMethod("LogWarning", BindingFlags.Public | BindingFlags.Instance)!;
    ...
    private void ResolveServices(HttpContext context)
    {
        ...
        sanitizedLogger = context.RequestServices.GetRequiredService(sanitizedLoggerType);
    ...
    private void LogDebug(string message, params object?[] args)
    {
        ...
        sanitizedLoggerDebug.Invoke(sanitizedLogger, [message, args]);
    }
    ...
    private void LogWarning(string message, params object?[] args)
    {
        ...
        sanitizedLoggerWarning.Invoke(sanitizedLogger, [message, args]);
    }
