...
/// <summary>
/// Runs CIBA token endpoint protocol tests against IStore-backed operational
/// stores using an in-memory SQLite database.
/// </summary>
public sealed class CibaTokenEndpointTests_IStore : CibaTokenEndpointTestsBase, IAsyncLifetime
{
    public CibaTokenEndpointTests_IStore()
    {
