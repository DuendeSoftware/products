...
public abstract class TokenEndpointTestsBase
{
    protected const string Category = "Token endpoint";

    protected string client_id = "client";
    protected string client_secret = "secret";

    protected string scope_name = "api";
    protected string scope_secret = "api_secret";

    protected IdentityServerPipeline _mockPipeline = new IdentityServerPipeline();

    protected TokenEndpointTestsBase()
    {
