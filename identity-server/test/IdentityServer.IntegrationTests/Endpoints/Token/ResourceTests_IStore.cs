...
/// <summary>
/// Runs resource indicator token endpoint tests against IStore-backed operational
/// stores using an in-memory SQLite database.
/// </summary>
public sealed class ResourceTests_IStore : ResourceTestsBase, IAsyncLifetime
{
    public ResourceTests_IStore()
    {
