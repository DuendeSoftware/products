...
public abstract class PushedAuthorizationTestsBase
{
    protected readonly IdentityServerPipeline _mockPipeline = new();
    ...
    protected PushedAuthorizationTestsBase()
    {
        ConfigureClientKeys();
        ConfigureClients();
        ConfigureUsers();
    ...
    protected void InitializePipeline()
    {
        ...
        // Must be set after Initialize() — options object is resolved from DI during Initialize
