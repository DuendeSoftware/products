...
public class ConfigurationProfileTests
{
    ...
    public void profile_should_be_invoked_when_registered()
    {
        ...
        {
            options.ConfigurationProfile.Profiles.Add("test-profile");
        });
        builder.Services.AddSingleton<IConfigurationProfileService>(profileService);
    ...
    public void multiple_profiles_should_all_be_invoked()
    {
        ...
        builder.Services.AddIdentityServer(options =>
        {
            options.ConfigurationProfile.Profiles.Add("test-profile-1");
            options.ConfigurationProfile.Profiles.Add("test-profile-2");
        });
        builder.Services.AddSingleton<IConfigurationProfileService>(profileService1);
        builder.Services.AddSingleton<IConfigurationProfileService>(profileService2);
    ...
    private class TestProfileService : IConfigurationProfileService
    {
        ...
        public void ApplyProfile(IdentityServerOptions options) => _applyAction(options);
