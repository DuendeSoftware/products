...
/// <summary>
/// Cross-storage integration tests for filtering and sorting by the system timestamp
...
public partial class SystemTimestampQueryTests
{
    ...
    public async Task Filter_by_created_gt_returns_entities_created_after_cutoff()
    {
        ...
        // Act
        var result = await queryStorage.QueryAsync<TestEntityDso>(_testEntityType, filter, SortParameter.Empty, page, Ct.None);
    ...
    public async Task Sort_by_created_ascending_returns_oldest_first()
    {
        ...
        // Act
        var result = await queryStorage.QueryAsync<TestEntityDso>(_testEntityType, Query.All(), sort, page, Ct.None);
    ...
    public async Task Filter_by_created_gte_and_sort_by_created_descending()
    {
        ...
        // Act
        var result = await queryStorage.QueryAsync<TestEntityDso>(_testEntityType, filter, sort, page, Ct.None);
    ...
    public async Task Project_created_and_last_updated_via_public_alias()
    {
        ...
        // Act
        var result = await queryStorage.QueryFieldsAsync(_testEntityType, fields, Query.All(), SortParameter.Empty, page, Ct.None);
