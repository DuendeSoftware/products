...
internal static class SpaceDso
{
    ...
    internal sealed record V1(
        ...
        [property: JsonPropertyName("d")] bool IsDeleted = false,
        [property: JsonPropertyName("eav")] IReadOnlyList<AttributeValueDso.V1>? ExtendedAttributeValues = null) : IDataStorageObject
    {
